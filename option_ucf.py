...
parser.add_argument('--test-flow-list', default='./list/ucf/flow_test.list', help='list of test flow features')
parser.add_argument('--gt', default='./list/ucf/gt_ucf.npy', help='file of ground truth ')
...
parser.add_argument('--max_epoch', type=int, default=65)
...
parser.add_argument('--n_bottleneck', type=int, default=4)
...
parser.add_argument('--model_path', default='./ckpt/UCF_833.pkl')
